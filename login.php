...
<head>
  <script src="./views/index/color-modes.js"></script>
  ...
  <link href="./view/index/sign-in.css" rel="stylesheet">
  ...
  <main class="form-signin w-100 m-auto">
    <form action="controllers/usuario.controllers.php?op=login" class="mb-3" method="POST">
      ...
      <div class="form-floating mb-3">
        <input type="text" class="form-control" id="correo" name="correo" placeholder="Ingrese su correo elctrónico"
          autofocus />
